			...
			<div class="container-fluid">
				...
				<c:forEach items="${HotProductList}" var="hotProduct">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/productInfo?pid=${hotProduct.pid}&cid=${hotProduct.category.cid}">
							<img src="${pageContext.request.contextPath}/${hotProduct.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/productInfo?pid=${hotProduct.pid}&cid=${hotProduct.category.cid}" style='color:#666'>${hotProduct.pname}</a></p>
						<p><font color="#E4393C" style="font-size:16px">&yen;${hotProduct.market_price}</font></p>
					</div>
				</c:forEach>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${NewProductList}" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/productInfo?pid=${newProduct.pid}&cid=${newProduct.category.cid}">
								<img src="${pageContext.request.contextPath}/${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath}/productInfo?pid=${newProduct.pid}&cid=${newProduct.category.cid}" style='color:#666'>${newProduct.pname}</a></p>

...
<body>
	...
	<div class="container">
					...
					<tbody>
						...
						<c:forEach items="${order.orderItems}" var="orderItem">
							<tr class="active">
								...
								<td width="20%">￥${orderItem.product.market_price}</td>
		...
		<div>
			<hr />
			<form id="confirmForm" class="form-horizontal" action="${pageContext.request.contextPath}/confirm" method="post"
				  style="margin-top: 5px; margin-left: 150px;">
				<!--通过隐藏域来完成post提交时需要提供额外的方法-->
